...
/*   Updated: 2022/06/14 08:49:03 by lauremass        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << "ClapTrap's Constructor : an unknown ClapTrap has been created and named by default John Doe" << std::endl;
}

ClapTrap::ClapTrap(std::string name): _name(name), _hitPoint(10), _energyPoint(10), _attackDamage(0)
{
	std::cout << "ClapTrap's Constructor called : " << this->_name << " has been created successfully" << std::endl;
}
...
{
	std::cout << "ClapTrap's Copy constructor called successfully" << std::endl;
}
...
{
	std::cout << "ClapTrap's Destructor called " << this->_name << " is dead" << std::endl;
}
...
{
	if (this->_hitPoint == 0)
		std::cout << "ClapTrap " << this->_name << " is already dead can't do anything" << std::endl;
...
void	ClapTrap::takeDamage(unsigned int amount)
{
	...
	{
		std::cout << this->_name << " has been attacked, this attack cause " << this->_hitPoint << " points of damage and died" << std::endl;
		this->_hitPoint = 0;
	}
	else
	{
		std::cout << this->_name << " has been attacked and loose " << amount << " points of life" << std::endl;
...
void	ClapTrap::beRepaired(unsigned int amount)
{
	...
	else
	{
		this->_energyPoint -= 1;
		this->_hitPoint += amount;
		std::cout << this->_name << " has be repaired and now have " << this->_hitPoint << " point of life" << std::endl;
